...
const Weather = ({city_name, color_name}: any) => {
    ...
    return (
        <div className="p-4">
            <div
                className={`bg-gradient-to-r w-96 h-56 m-auto from-${color_name}-500 to-${color_name}-300 rounded-xl shadow-2xl transform hover:scale-110 transition-transform text-white relative`}>
